...
function playTrack(idx, autoplay=false){
  ...
  el.src=track.url; el.volume=parseFloat(volBar.value); el.playbackRate=parseFloat(speedSelect.value); el.load();
...
speedSelect.addEventListener('change',()=>{ const r=parseFloat(speedSelect.value); audioEl.playbackRate=r; videoEl.playbackRate=r; });
